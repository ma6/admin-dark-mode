...
* Block editor: dark meta-boxes area at the bottom (.edit-post-meta-boxes-
  main) — the white bar that appears when a plugin registers a classic
  meta box — plus its resize handle and the entities-saved-states panel.

= 0.1.8 =
* Block inserter: the block-type icons and labels (Paragraph, Heading, …)
  were near-black on the now-dark panel — forced to the light text colour.
